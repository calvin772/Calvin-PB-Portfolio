...
This data package contains the data that powers the chart ["Nuclear power generation"](https://ourworldindata.org/grapher/nuclear-energy-generation?tab=line&country=FRA~SWE~GBR~JPN~USA~DEU&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on February 06, 2026.

### Active Filters

A filtered subset of the full data was downloaded. The following filters were applied:
- country: FRA, SWE, GBR, JPN, USA, DEU
- tab: line
